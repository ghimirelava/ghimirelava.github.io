var Website = /** @class */ (function () {
    function Website() {
        this.projects = [
            ...
            { id: 4, title: "OS history command or emulator project", description: "Show understanding of of asm and low level concepts or os concepts", image: "public/images/project4.jpg", languages: ["C", "ASM", "RISC V"] },
        ];
