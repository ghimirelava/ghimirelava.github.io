var Website = /** @class */ (function () {
    function Website() {
        this.projects = [
            ...
            { id: 2, title: "Web Application Frontend", description: "Duets.AI is a language learning startup that utilizes AI to provide personalized feedback and exercises from Zoom tutoring sessions. I was one of the two front-end developers who designed and developed the user interface. Emphasis was placed on ensuring a seamless user interface and assiting the back-end team to integrate dynamic data through custom API calls to establish the websites core functionalities.", image: "public/images/duets.jpg", languages: ["Bubble.io", "HTML", "Azure"] },
